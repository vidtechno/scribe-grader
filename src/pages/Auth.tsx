            ...
            {googleLoading ? (
              ...
              <>
                <svg className="h-4 w-4" viewBox="0 0 24 24">
                  ...
                  <path fill="#FBBC05" d="M5.84 14.1c-.22-.66-.35-1.36-.35-2.1s.13-1.44.35-2.1V7.06H2.18C1.43 8.55 1 10.22 1 12s.43 3.45 1.18 4.94l2.66-2.84c-.87-2.6 3.3-4.53 6.16-4.53z" transform="translate(-3.3 -1.5) scale(0.97)"/>
